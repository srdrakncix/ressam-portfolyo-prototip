...
UI = {
    'tr': {
        ...
        'hero_alt': 'Sekiz eser bir sergi salonunda, duvarlara asili.',
                'zoom_ipucu': 'Sürükleyerek gezinin · çift dokunuş yakınlaştırır',
'gal_label': 'Katalog',
    ...
    'en': {
        ...
        'hero_alt': 'Eight paintings hung together in a gallery room.',
                'zoom_ipucu': 'Drag to pan · double-tap to zoom',
'gal_label': 'Catalogue',
        'gal_title': 'All works',
    ...
    'fr': {
        ...
        'hero_alt': "Huit tableaux accrochés ensemble dans une"
                    " salle d'exposition.",
                'zoom_ipucu': "Faites glisser pour naviguer · double-tapez pour zoomer",
'gal_label': 'Catalogue',
